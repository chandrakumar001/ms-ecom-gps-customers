...
pipeline {
    ...
    stages {
        ...
        stage('Build Docker Image') {
            steps {
                ...
                withDockerRegistry(credentialsId: 'chandran-edu-docker-treescale-secret', url: 'https://repo.treescale.com/') {
                    bat 'docker build . -t repo.treescale.com/chandrakumar001/ms-ecom-gps-customers:' + pomVersion
                    bat 'echo the image to docker'
                    bat 'docker push repo.treescale.com/chandrakumar001/ms-ecom-gps-customers:' + pomVersion

                    bat 'echo the latest image to docker'
                    bat 'docker tag repo.treescale.com/chandrakumar001/ms-ecom-gps-customers:' + pomVersion + ' repo.treescale.com/chandrakumar001/ms-ecom-gps-customers:latest'
                    bat 'docker push repo.treescale.com/chandrakumar001/ms-ecom-gps-customers:latest'

                    bat 'echo Delete the image from jenkins'
                    bat 'docker rmi -f repo.treescale.com/chandrakumar001/ms-ecom-gps-customers:' + pomVersion + ' repo.treescale.com/chandrakumar001/ms-ecom-gps-customers:latest'
                }
            }
        }
        // stage('Deploy') {
        ...
        //             sh 'kubectl set image deployment/ms-ecom-gps-customers ms-ecom-gps-customers=repo.treescale.com/chandrakumar001/ms-ecom-gps-customers:'+pomVersion
        //         }
        //     }
        // }
        //end
